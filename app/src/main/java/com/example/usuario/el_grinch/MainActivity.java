package com.example.usuario.el_grinch;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void chargeSoundPool() {
        ...
        resAtrevidos = spAgenda.load(getApplicationContext(), R.raw.odiasnavidad, 1);
        resVerde = spVerde.load(getApplicationContext(), R.raw.soyverde, 1);
